export default class ActionTypes {
    public static KOREAN_AVAILABILITY_UPDATED: string = 'KOREAN_AVAILABILITY_UPDATED';
    public static JAPANESE_AVAILABILITY_UPDATED: string = 'JAPANESE_AVAILABILITY_UPDATED';
    ...
    public static FLASH_CARD_REVEALED: string = 'FLASH_CARD_REVEALED';
    public static FLASH_CARD_ADVANCED: string = 'FLASH_CARD_ADVANCED';
}
