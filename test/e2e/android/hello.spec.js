...
describe('Hello', () => {
    ...
    it('should render', () => wdBrowser.sleep(3000)
        ...
        .text((err, text) => {
            expect(text).toEqual('To show the dev menu, shake the device or press ' +
                'menu button on Android, or cmd + D on iOS');
        })
    ...
    it('should update after a tap on button', () => wdBrowser
        ...
        .elementByXPath('//android.widget.TextView[@text=\'Show more\']').click()
        .sleep(100)
        .elementsByClassName('android.widget.TextView')
        .then((els) => {
